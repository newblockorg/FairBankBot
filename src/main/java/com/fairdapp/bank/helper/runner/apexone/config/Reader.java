package com.fairdapp.bank.helper.runner.apexone.config;
...
public class Reader {
	...
	public List<ApexOneConfig> readconfigs(String folderpath){
		List<ApexOneConfig> result = new ArrayList<ApexOneConfig>();
		...
		for(Properties p:configs) {
			...
			for(int i = 1 ; i <100 ;i++ ) {
				 ...
				 if(pk!=null) {
					 	ApexOneConfig config =  new ApexOneConfig();
